...
// Tabela de simbolos de funções
struct st_symbol_table_func {
    type_symbol_function_entry variable[MAX_SYMBOLS];
    int n_variables;
    struct st_symbol_table_func *next;
};
typedef struct st_symbol_table_func type_symbol_table_func;
